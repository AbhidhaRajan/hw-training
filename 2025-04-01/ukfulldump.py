...
# Read CSV file
df = pd.read_csv("/home/abhidha/Downloads/DataHut_UK_Next_FullDump_20250401.CSV", delimiter='|')
...
unique_urls = df['dh_unique_id'].nunique()
print(f"Unique URLs: {unique_urls}")

#  Unique values in specific columns
specific_columns = ["competitor_name", "extraction_date", "gender", "currency"]
